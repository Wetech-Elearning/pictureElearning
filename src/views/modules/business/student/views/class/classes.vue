    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <a style="cursor: pointer" @click="toClassdetails(scope.row.uuid)">{{scope.row.className}}</a>
        </template>
      </el-table-column>
      <el-table-column
        prop="startDate"
...
<!--          <li @click="toExamMsg(item.uuid)" class="item" v-for="(item,index) in dataList" :key="index">-->
<!--            &lt;!&ndash;<h2 @click="toExamMsg(item.uuid)">{{item.className}}</h2>&ndash;&gt;-->
