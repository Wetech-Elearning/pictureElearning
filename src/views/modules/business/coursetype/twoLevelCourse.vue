  ...
  <div class="mod-config">
    ...
    <el-table
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        :label="$t('course_type.cover')">
        <template width="90" slot-scope="scope">
          <img style="width:65px;height:80px;border:none;" :src="scope.row.courseCover">
        </template>
      </el-table-column>
      <el-table-column
        prop="courseTypeName"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        :label="$t('course_type.is_public')" :formatter="typeFormatter">
      </el-table-column>
      <el-table-column
        prop="remark"
        header-align="center"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <svg class="icon" aria-hidden="true" @click="upload(scope.row.uuid)">
...
<script>
  import AddOrUpdate from './twoLevelCourse-add-or-update'
  ...
  export default {
    ...
    methods: {
      ...
      upload(id){
        ...
        this.$nextTick(() => {
          this.$refs.upload.init(id,'image','图片','课程封面')
        })
      },
      // 添加课程
