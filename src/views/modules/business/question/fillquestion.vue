  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('business:fillquestion:add')" type="primary" @click="addOrUpdateHandle()">{{$t('button.add')}}</el-button>
        <el-button v-if="isAuth('business:fillquestion:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">{{$t('button.batch_delete')}}</el-button>
      </el-form-item>
    </el-form>
    <el-table
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/fillquestion/list'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(this.message.confirm_to + this.message.conduct +`[${this.message.delete}]`+ this.message.oper +`?`, this.message.tip, {
          ...
          this.$http({
            url: this.$http.adornUrl('/generator/fillquestion/delete'),
            method: 'post',
