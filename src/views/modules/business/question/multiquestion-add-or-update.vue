  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="80px">
      ...
      <el-form-item :label="$t('question.question_right')" prop="answer">
        <el-select v-model="dataForm.answer" :placeholder="$t('question.question_right')" multiple style="width:100%;">
          <el-option
          ...
          if (this.dataForm.uuid) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.answer = 'multi' === data.multiQuestion.questionType ? data.multiQuestion.answer.split(''):data.multiQuestion.answer
          ...
          if (valid) {
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'answer': this.dataForm.answer.join().replaceAll(',',''),
