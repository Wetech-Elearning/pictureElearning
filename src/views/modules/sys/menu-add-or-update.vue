<template>
  <el-dialog
    :title="!dataForm.id ? $t('button.add') : $t('button.update')"
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item v-if="dataForm.hidden !== 0" label="是否隐藏" prop="perms">
        <el-select v-model="dataForm.hidden" style="width: 100%;">
