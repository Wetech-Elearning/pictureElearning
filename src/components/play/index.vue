<template>
  <div>
    <el-dialog
      ...
      <video v-if="dataForm.fileType=='video'" ref="myvideo"  controls  @canplay="getTotal" @timeupdate="timeupdate" @durationchange="durationchange" style="width: 100%;">
  ...
  export default {
    ...
    methods: {
      ...
      durationchange () {
        ...
        if (this.isFirst) {
          this.$refs.myvideo.currentTime = 3
          this.isFirst = false
        }
      },
      getTotal () {
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                if (this.dataForm.fileType == 'video') {
                  ...
                  this.iframeUrl = window.SITE_CONFIG.preViewsurl + encodeURIComponent(this.dataForm.fileUrl)
                }
              }
            })
          }
